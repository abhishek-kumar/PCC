...
def processDataset(datafile_train, datafile_test, resultfile_train, resultfile_test, p, k):
		...
		logf.info("Training BinaryRelevance")
		...
		logf.info("BR: Test Set Hamming Loss: " + str(hl))
		logf.info("BR Test Set 0-1 Loss: " + str(sl))
		logf.info("BR Test Set Rank Loss: " + str(rl))
		#logf.info("BR Test Set Log Loss: " + str(ll))
		logf.info("BR Test Set Normalized Rank Loss: " + str(nrl))
		logf.info("BR Test Set One-Error: " + str(oe))
		logf.info("BR Test Set Avg Prec: " + str(avprec))
...
if __name__ == "__main__":
		...
		logging.basicConfig(filename="./output/BinaryRelevance.log", level=logging.DEBUG)
		logf = logging.getLogger(__name__)
